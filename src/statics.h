...
extern int32_t	g_lookup[65536];
extern float	g_saw[(NOTE_MAX + 25) * WAVETABLE_LENGTH * 2];
extern float	g_parabola[(NOTE_MAX + 25) * WAVETABLE_LENGTH * 2];
extern int32_t	g_step[PITCH_MAX];

extern int32_t	g_semi[128];
extern int32_t	g_fine[128];
...
extern uint32_t _RND;
extern int32_t _RND1, _RND2;
...
extern int32_t	g_lfo_step[4096];
